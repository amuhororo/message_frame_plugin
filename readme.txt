...
　◆機能
   ...
   ・positionの各種 margin値 を全て padding に統一する（個人的にややこしいので）。
...
　　　nopadding    true/false/数値 　true     message_inner ppadding-topを0にする場合は true ※数値でpadding値指定可
...
■自動改ページについて
-------------------------------------------------------------------------------------------------
　ある程度の文字数で、改行（[r]でなくて良い）かティラノスクリプトのタグが無いと枠からははみ出ます。
